...
* @returns data
*/
export default function getDetail(params: any = {}, options: Object = {}) {
  return this.get('http://cdn.bootcdn.net/ajax/libs/lodash.js/4.17.21/lodash.core.js', params, options)
}
